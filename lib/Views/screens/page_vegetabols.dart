...
class PageVegetables extends StatelessWidget {
  const PageVegetables({super.key});
        ...
        body: BlocBuilder<ProductCubit, ProductState>(
          builder: (context, state) {
            if (state is ProductLoading) {
              ...
              // فلترة المنتجات لتشمل فقط الخضروات بناءً على sub_category_id
              final vegetables = allProducts
                  .where((product) => product.subCategoryId == '4')
                  .toList();
